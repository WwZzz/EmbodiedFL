...
train_paras = [
    (ROOT_DIR + "/robot/threading_d1_iiwa.hdf5", 'train'),
    (ROOT_DIR + "/robot/threading_d1_panda.hdf5", 'train'),
    (ROOT_DIR + "/robot/threading_d1_sawyer.hdf5", 'train'),
    (ROOT_DIR + "/robot/threading_d1_ur5e.hdf5", 'train'),
]
val_paras = [
    (ROOT_DIR + "/robot/threading_d1_iiwa.hdf5", 'valid'),
    (ROOT_DIR + "/robot/threading_d1_panda.hdf5", 'valid'),
    (ROOT_DIR + "/robot/threading_d1_sawyer.hdf5", 'valid'),
    (ROOT_DIR + "/robot/threading_d1_ur5e.hdf5", 'valid'),
]
