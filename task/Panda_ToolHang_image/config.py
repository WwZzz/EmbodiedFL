...
# ['robot0_eef_pos', 'robot0_eef_quat', 'robot0_eye_in_hand_image', 'robot0_gripper_qpos', 'sideview_image']
obs = {
    "low_dim": ['robot0_eef_pos', 'robot0_eef_quat', 'robot0_gripper_qpos'],
    "rgb": ["sideview_image", "robot0_eye_in_hand_image"],
    "depth": [],
    "scan": [],
}
...
def create_config(data_path, filter_by_attribute, seq_length=10):
    return {
        'hdf5_path': data_path,
        'obs_keys': ['sideview_image', 'robot0_eef_pos', 'robot0_eef_quat', 'robot0_eye_in_hand_image','robot0_gripper_qpos'],
...
train_paras = [
    (ROOT_DIR + "/tool_hang/ph/image_v15.hdf5", f'train_{i}') for i in range(20)
]
val_paras = [
    (ROOT_DIR + "/tool_hang/ph/image_v15.hdf5", f'valid_{i}') for i in range(20)
]
...
def get_model():
    ...
    obs_key_shapes = OrderedDict([('sideview_image', [3, 240, 240]), ('robot0_eef_pos', [3]), ('robot0_eef_quat', [4]), ('robot0_eye_in_hand_image', [3, 240, 240]), ('robot0_gripper_qpos', [2])])
    obs_config = Config(**{
        "modalities": {
            "obs": obs,
            "goal": {
