...
train_paras = [
    (ROOT_DIR + "/can/ph/image_v15.hdf5", 'train_n4_0'),
    (ROOT_DIR + "/can/ph/image_v15.hdf5", 'train_n4_1'),
    (ROOT_DIR + "/can/ph/image_v15.hdf5", 'train_n4_2'),
    (ROOT_DIR + "/can/ph/image_v15.hdf5", 'train_n4_3'),
    (ROOT_DIR + "/can/mh/image_v15.hdf5", 'better_operator_1_train'),
    (ROOT_DIR + "/can/mh/image_v15.hdf5", 'better_operator_2_train'),
    (ROOT_DIR + "/can/mh/image_v15.hdf5", 'okay_operator_1_train'),
    (ROOT_DIR + "/can/mh/image_v15.hdf5", 'okay_operator_2_train'),
    (ROOT_DIR + "/can/mh/image_v15.hdf5", 'worse_operator_1_train'),
    (ROOT_DIR + "/can/mh/image_v15.hdf5", 'worse_operator_2_train'),
    # (ROOT_DIR + "/can/mg/low_dim_sparse_v15.hdf5", 'group_1'),
    # (ROOT_DIR + "/can/mg/low_dim_sparse_v15.hdf5", 'group_15'),
    # (ROOT_DIR + "/can/mg/low_dim_sparse_v15.hdf5", 'group_30'),
    # (ROOT_DIR + "/can/mg/low_dim_sparse_v15.hdf5", 'group_45'),
]
val_paras = [
    (ROOT_DIR + "/can/ph/image_v15.hdf5", 'valid_n4_0'),
    (ROOT_DIR + "/can/ph/image_v15.hdf5", 'valid_n4_1'),
    (ROOT_DIR + "/can/ph/image_v15.hdf5", 'valid_n4_2'),
    (ROOT_DIR + "/can/ph/image_v15.hdf5", 'valid_n4_3'),
    (ROOT_DIR + "/can/mh/image_v15.hdf5", 'better_operator_1_valid'),
    (ROOT_DIR + "/can/mh/image_v15.hdf5", 'better_operator_2_valid'),
    (ROOT_DIR + "/can/mh/image_v15.hdf5", 'okay_operator_1_valid'),
    (ROOT_DIR + "/can/mh/image_v15.hdf5", 'okay_operator_2_valid'),
    (ROOT_DIR + "/can/mh/image_v15.hdf5", 'worse_operator_1_valid'),
    (ROOT_DIR + "/can/mh/image_v15.hdf5", 'worse_operator_2_valid'),
    # (ROOT_DIR + "/can/mg/low_dim_sparse_v15.hdf5", 'group_2'),
    # (ROOT_DIR + "/can/mg/low_dim_sparse_v15.hdf5", 'group_16'),
    # (ROOT_DIR + "/can/mg/low_dim_sparse_v15.hdf5", 'group_31'),
    # (ROOT_DIR + "/can/mg/low_dim_sparse_v15.hdf5", 'group_46'),
]
