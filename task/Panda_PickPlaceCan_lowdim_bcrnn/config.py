...
train_paras = [
    (ROOT_DIR + "/can/ph/low_dim_v15.hdf5", 'train'),
    (ROOT_DIR + "/can/mh/low_dim_v15.hdf5", 'better_operator_1_train'),
    (ROOT_DIR + "/can/mh/low_dim_v15.hdf5", 'better_operator_2_train'),
    (ROOT_DIR + "/can/mh/low_dim_v15.hdf5", 'okay_operator_1_train'),
    (ROOT_DIR + "/can/mh/low_dim_v15.hdf5", 'okay_operator_2_train'),
    (ROOT_DIR + "/can/mh/low_dim_v15.hdf5", 'worse_operator_1_train'),
    (ROOT_DIR + "/can/mh/low_dim_v15.hdf5", 'worse_operator_2_train'),
...
val_paras = [
    (ROOT_DIR + "/can/ph/low_dim_v15.hdf5", 'valid'),
    (ROOT_DIR + "/can/mh/low_dim_v15.hdf5", 'better_operator_1_valid'),
    (ROOT_DIR + "/can/mh/low_dim_v15.hdf5", 'better_operator_2_valid'),
    (ROOT_DIR + "/can/mh/low_dim_v15.hdf5", 'okay_operator_1_valid'),
    (ROOT_DIR + "/can/mh/low_dim_v15.hdf5", 'okay_operator_2_valid'),
    (ROOT_DIR + "/can/mh/low_dim_v15.hdf5", 'worse_operator_1_valid'),
    (ROOT_DIR + "/can/mh/low_dim_v15.hdf5", 'worse_operator_2_valid'),
