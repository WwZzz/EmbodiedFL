...
train_paras = [
    (ROOT_DIR + "robot/square_d1_iiwa.hdf5", 'train'),
    (ROOT_DIR + "robot/square_d1_panda.hdf5", 'train'),
    (ROOT_DIR + "robot/square_d1_sawyer.hdf5", 'train'),
    (ROOT_DIR + "robot/square_d1_ur5e.hdf5", 'train'),
]
val_paras = [
    (ROOT_DIR + "robot/square_d1_iiwa.hdf5", 'valid'),
    (ROOT_DIR + "robot/square_d1_panda.hdf5", 'valid'),
    (ROOT_DIR + "robot/square_d1_sawyer.hdf5", 'valid'),
    (ROOT_DIR + "robot/square_d1_ur5e.hdf5", 'valid'),
]
...
obs_key_shapes = OrderedDict([('object', [17]), ('robot0_eef_pos', [3]), ('robot0_eef_quat', [4]), ('robot0_gripper_qpos', [6])])
trains = [ObsPaddingDataset(SequenceDataset(**create_config(*pi)), obs_key_shapes) for pi in train_paras]
vals = [ObsPaddingDataset(SequenceDataset(**create_config(*pi)), obs_key_shapes) for pi in val_paras]
# train_data = trains
