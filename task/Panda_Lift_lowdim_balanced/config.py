...
def create_config(data_path, filter_by_attribute, seq_length=1):
    return {
        'hdf5_path': data_path,
...
train_paras = [
    (ROOT_DIR + "/lift/ph/low_dim_v15.hdf5", 'train_n4_0'),
    (ROOT_DIR + "/lift/ph/low_dim_v15.hdf5", 'train_n4_1'),
    (ROOT_DIR + "/lift/ph/low_dim_v15.hdf5", 'train_n4_2'),
    (ROOT_DIR + "/lift/ph/low_dim_v15.hdf5", 'train_n4_3'),
    (ROOT_DIR + "/lift/mh/low_dim_v15.hdf5", 'better_operator_1_train'),
    (ROOT_DIR + "/lift/mh/low_dim_v15.hdf5", 'better_operator_2_train'),
    (ROOT_DIR + "/lift/mh/low_dim_v15.hdf5", 'okay_operator_1_train'),
    (ROOT_DIR + "/lift/mh/low_dim_v15.hdf5", 'okay_operator_2_train'),
    (ROOT_DIR + "/lift/mh/low_dim_v15.hdf5", 'worse_operator_1_train'),
    (ROOT_DIR + "/lift/mh/low_dim_v15.hdf5", 'worse_operator_2_train'),
    # (ROOT_DIR + "/lift/mg/low_dim_sparse_v15.hdf5", 'group_1'),
    # (ROOT_DIR + "/lift/mg/low_dim_sparse_v15.hdf5", 'group_15'),
    # (ROOT_DIR + "/lift/mg/low_dim_sparse_v15.hdf5", 'group_30'),
    # (ROOT_DIR + "/lift/mg/low_dim_sparse_v15.hdf5", 'group_45'),
]
val_paras = [
    (ROOT_DIR + "/lift/ph/low_dim_v15.hdf5", 'valid_n4_0'),
    (ROOT_DIR + "/lift/ph/low_dim_v15.hdf5", 'valid_n4_1'),
    (ROOT_DIR + "/lift/ph/low_dim_v15.hdf5", 'valid_n4_2'),
    (ROOT_DIR + "/lift/ph/low_dim_v15.hdf5", 'valid_n4_3'),
    (ROOT_DIR + "/lift/mh/low_dim_v15.hdf5", 'better_operator_1_valid'),
    (ROOT_DIR + "/lift/mh/low_dim_v15.hdf5", 'better_operator_2_valid'),
    (ROOT_DIR + "/lift/mh/low_dim_v15.hdf5", 'okay_operator_1_valid'),
    (ROOT_DIR + "/lift/mh/low_dim_v15.hdf5", 'okay_operator_2_valid'),
    (ROOT_DIR + "/lift/mh/low_dim_v15.hdf5", 'worse_operator_1_valid'),
    (ROOT_DIR + "/lift/mh/low_dim_v15.hdf5", 'worse_operator_2_valid'),
    # (ROOT_DIR + "/lift/mg/low_dim_sparse_v15.hdf5", 'group_2'),
    # (ROOT_DIR + "/lift/mg/low_dim_sparse_v15.hdf5", 'group_16'),
    # (ROOT_DIR + "/lift/mg/low_dim_sparse_v15.hdf5", 'group_31'),
    # (ROOT_DIR + "/lift/mg/low_dim_sparse_v15.hdf5", 'group_46'),
]
