...
obs_key_shapes = OrderedDict([
    ...
    ('robot1_eef_pos', [3]),
    ('robot1_eef_quat', [4]),
    ('robot1_eye_in_hand_image', [3, 84, 84]),
    ('robot1_gripper_qpos', [2]),
    ('shouldercamera0_image', [3, 84, 84]),
    ('shouldercamera1_image', [3, 84, 84])
])
MODALITIES = {
    "obs": {
        "low_dim": [
...
train_paras = [
    (ROOT_DIR + "/transport/ph/image_v15.hdf5", 'train_n4_0'),
    (ROOT_DIR + "/transport/ph/image_v15.hdf5", 'train_n4_1'),
    (ROOT_DIR + "/transport/ph/image_v15.hdf5", 'train_n4_2'),
    (ROOT_DIR + "/transport/ph/image_v15.hdf5", 'train_n4_3'),
...
val_paras = [
    (ROOT_DIR + "/transport/ph/image_v15.hdf5", 'valid_n4_0'),
    (ROOT_DIR + "/transport/ph/image_v15.hdf5", 'valid_n4_1'),
    (ROOT_DIR + "/transport/ph/image_v15.hdf5", 'valid_n4_2'),
    (ROOT_DIR + "/transport/ph/image_v15.hdf5", 'valid_n4_3'),
