...
train_paras = [
    (ROOT_DIR + "/square/ph/low_dim_v15.hdf5", 'train_n4_0'),
    (ROOT_DIR + "/square/ph/low_dim_v15.hdf5", 'train_n4_1'),
    (ROOT_DIR + "/square/ph/low_dim_v15.hdf5", 'train_n4_2'),
    (ROOT_DIR + "/square/ph/low_dim_v15.hdf5", 'train_n4_3'),
...
val_paras = [
    (ROOT_DIR + "/square/ph/low_dim_v15.hdf5", 'valid_n4_0'),
    (ROOT_DIR + "/square/ph/low_dim_v15.hdf5", 'valid_n4_1'),
    (ROOT_DIR + "/square/ph/low_dim_v15.hdf5", 'valid_n4_2'),
    (ROOT_DIR + "/square/ph/low_dim_v15.hdf5", 'valid_n4_3'),
